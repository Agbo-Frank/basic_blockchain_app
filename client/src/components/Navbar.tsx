...
function NavbarItem( {className, title}: {className?: string, title: string}){
    return(
    ...
    return (
        <nav className="w-full flex md:justify-center justify-between items-center p-4">
            ...
            <ul className="text-white md:flex hidden list-none flex-row justify-between items-center flex-initial">
                {
                    ["Market", "Exchange", "Tutorial", "Wallets"].map((item, index) => <NavbarItem className="text-white" title={item} key={index} />)
                }
            ...
            <div className="flex relative">
                ...
                }
                {
                    ...
                    >
                        ...
                        {
                            ["Market", "Exchange", "Tutorial", "Wallets"].map((item, index) => <NavbarItem title={item} key={index} className="my-2 text-lg" />)
                        }
                    </ul>
                }
            </div>
